...
class ErrorHelper {
    ...
    public function __construct($templatesDir) {
        ...
        } else throw new \Exception("Ошибка: Помощник не был создан");
    ...
    function dispatch(\Throwable $e, $appStatus = self::APP_IN_PRODUCTION, $userID = 0)
    {
        switch ($appStatus) {
            ...
            case self::APP_IN_PRODUCTION:
                $userMes = 'Непредвиденная ошибка, логи отправлены разработчикам. Пожалуйста, попробуйте снова!';
    ...
    function addToLog($message, $logpath)
    {
        ...
        } else throw new \Exception('Расположение лог файла не читаемо');
    }
